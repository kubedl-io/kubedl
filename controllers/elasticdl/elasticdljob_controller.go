...
func (r *ElasticDLJobReconciler) Reconcile(_ context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	result, err := r.ctrl.ReconcileJobs(elasticdlJob, elasticdlJob.Spec.ElasticDLReplicaSpecs, elasticdlJob.Status, &elasticdlJob.Spec.RunPolicy, nil, nil, elasticdlJob.Spec.GitSyncConfig)
	if err != nil {
