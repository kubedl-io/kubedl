...
func (r *NotebookReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if errors.IsNotFound(err) {
			...
			ingress := generateIngress(nbService, notebook, pod)
...
func setJuypterLabEnv(pod *corev1.Pod) error {
...
func generateService(pod *corev1.Pod, nb *notebookv1alpha1.Notebook) *corev1.Service {
	...
	labels := map[string]string{
		notebookv1alpha1.NotebookNameLabel: pod.Name,
	}
