...
func (r *XgboostJobReconciler) Reconcile(_ context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	result, err := r.ctrl.ReconcileJobs(xgboostjob, xgboostjob.Spec.XGBReplicaSpecs, xgboostjob.Status.JobStatus, &xgboostjob.Spec.RunPolicy, nil, nil, xgboostjob.Spec.GitSyncConfig)
	if err != nil {
