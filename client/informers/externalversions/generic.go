...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("tfjobs"):
		...
		// Group=xdl.kubedl.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("xdljobs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Xdl().V1alpha1().XDLJobs().Informer()}, nil

		// Group=xgboostjob.kubeflow.org, Version=v1alpha1
	case xgboostv1alpha1.SchemeGroupVersion.WithResource("xgboostjobs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Xgboostjob().V1alpha1().XGBoostJobs().Informer()}, nil
