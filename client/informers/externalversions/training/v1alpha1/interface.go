...
// ElasticDLJobs returns a ElasticDLJobInformer.
func (v *version) ElasticDLJobs() ElasticDLJobInformer {
	return &elasticDLJobInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
...
// MarsJobs returns a MarsJobInformer.
func (v *version) MarsJobs() MarsJobInformer {
...
// XDLJobs returns a XDLJobInformer.
func (v *version) XDLJobs() XDLJobInformer {
	return &xDLJobInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
