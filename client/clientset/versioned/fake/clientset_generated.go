...
import (
	clientset "github.com/alibaba/kubedl/client/clientset/versioned"
	kubeflowv1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/pytorch/v1"
	fakekubeflowv1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/pytorch/v1/fake"
	kubeflowv1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/tensorflow/v1"
	fakekubeflowv1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/tensorflow/v1/fake"
	xdlv1alpha1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/xdl/v1alpha1"
	fakexdlv1alpha1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/xdl/v1alpha1/fake"
	xgboostjobv1alpha1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/xgboost/v1alpha1"
	fakexgboostjobv1alpha1 "github.com/alibaba/kubedl/client/clientset/versioned/typed/xgboost/v1alpha1/fake"
...
func (c *Clientset) XdlV1alpha1() xdlv1alpha1.XdlV1alpha1Interface {
	return &fakexdlv1alpha1.FakeXdlV1alpha1{Fake: &c.Fake}
}
...
func (c *Clientset) XgboostjobV1alpha1() xgboostjobv1alpha1.XgboostjobV1alpha1Interface {
	return &fakexgboostjobv1alpha1.FakeXgboostjobV1alpha1{Fake: &c.Fake}
}
