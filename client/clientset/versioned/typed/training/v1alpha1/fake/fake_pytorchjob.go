...
var pytorchjobsResource = schema.GroupVersionResource{Group: "training.kubedl.io", Version: "v1alpha1", Resource: "pytorchjobs"}

var pytorchjobsKind = schema.GroupVersionKind{Group: "training.kubedl.io", Version: "v1alpha1", Kind: "PyTorchJob"}
...
func (c *FakePyTorchJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PyTorchJobList, err error) {
	...
	list := &v1alpha1.PyTorchJobList{ListMeta: obj.(*v1alpha1.PyTorchJobList).ListMeta}
...
func (c *FakePyTorchJobs) UpdateStatus(ctx context.Context, pyTorchJob *v1alpha1.PyTorchJob, opts v1.UpdateOptions) (*v1alpha1.PyTorchJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(pytorchjobsResource, "status", c.ns, pyTorchJob), &v1alpha1.PyTorchJob{})
...
func (c *FakePyTorchJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PyTorchJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(pytorchjobsResource, c.ns, name, pt, data, subresources...), &v1alpha1.PyTorchJob{})
