...
var tfjobsResource = schema.GroupVersionResource{Group: "training.kubedl.io", Version: "v1alpha1", Resource: "tfjobs"}

var tfjobsKind = schema.GroupVersionKind{Group: "training.kubedl.io", Version: "v1alpha1", Kind: "TFJob"}
...
func (c *FakeTFJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TFJobList, err error) {
	...
	list := &v1alpha1.TFJobList{ListMeta: obj.(*v1alpha1.TFJobList).ListMeta}
...
func (c *FakeTFJobs) UpdateStatus(ctx context.Context, tFJob *v1alpha1.TFJob, opts v1.UpdateOptions) (*v1alpha1.TFJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tfjobsResource, "status", c.ns, tFJob), &v1alpha1.TFJob{})
...
func (c *FakeTFJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TFJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tfjobsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TFJob{})
