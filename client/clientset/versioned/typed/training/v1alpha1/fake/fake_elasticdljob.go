...
var elasticdljobsResource = schema.GroupVersionResource{Group: "training.kubedl.io", Version: "v1alpha1", Resource: "elasticdljobs"}

var elasticdljobsKind = schema.GroupVersionKind{Group: "training.kubedl.io", Version: "v1alpha1", Kind: "ElasticDLJob"}
...
func (c *FakeElasticDLJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElasticDLJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(elasticdljobsResource, c.ns, name), &v1alpha1.ElasticDLJob{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ElasticDLJob), err
}
...
func (c *FakeElasticDLJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElasticDLJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(elasticdljobsResource, elasticdljobsKind, c.ns, opts), &v1alpha1.ElasticDLJobList{})
	...
	list := &v1alpha1.ElasticDLJobList{ListMeta: obj.(*v1alpha1.ElasticDLJobList).ListMeta}
	for _, item := range obj.(*v1alpha1.ElasticDLJobList).Items {
...
func (c *FakeElasticDLJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(elasticdljobsResource, c.ns, opts))
...
func (c *FakeElasticDLJobs) Create(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.CreateOptions) (result *v1alpha1.ElasticDLJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(elasticdljobsResource, c.ns, elasticDLJob), &v1alpha1.ElasticDLJob{})
...
func (c *FakeElasticDLJobs) Update(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.UpdateOptions) (result *v1alpha1.ElasticDLJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(elasticdljobsResource, c.ns, elasticDLJob), &v1alpha1.ElasticDLJob{})
...
func (c *FakeElasticDLJobs) UpdateStatus(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.UpdateOptions) (*v1alpha1.ElasticDLJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(elasticdljobsResource, "status", c.ns, elasticDLJob), &v1alpha1.ElasticDLJob{})
...
func (c *FakeElasticDLJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(elasticdljobsResource, c.ns, name), &v1alpha1.ElasticDLJob{})
...
func (c *FakeElasticDLJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(elasticdljobsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ElasticDLJobList{})
	return err
}
...
func (c *FakeElasticDLJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElasticDLJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(elasticdljobsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ElasticDLJob{})
