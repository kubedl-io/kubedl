...
var xdljobsResource = schema.GroupVersionResource{Group: "training.kubedl.io", Version: "v1alpha1", Resource: "xdljobs"}

var xdljobsKind = schema.GroupVersionKind{Group: "training.kubedl.io", Version: "v1alpha1", Kind: "XDLJob"}
...
func (c *FakeXDLJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(xdljobsResource, c.ns, listOpts)
