...
func newXDLJobs(c *TrainingV1alpha1Client, namespace string) *xDLJobs {
	return &xDLJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *xDLJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.XDLJob, err error) {
...
func (c *xDLJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.XDLJobList, err error) {
...
func (c *xDLJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *xDLJobs) Create(ctx context.Context, xDLJob *v1alpha1.XDLJob, opts v1.CreateOptions) (result *v1alpha1.XDLJob, err error) {
	result = &v1alpha1.XDLJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("xdljobs").
...
func (c *xDLJobs) Update(ctx context.Context, xDLJob *v1alpha1.XDLJob, opts v1.UpdateOptions) (result *v1alpha1.XDLJob, err error) {
	result = &v1alpha1.XDLJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xdljobs").
...
func (c *xDLJobs) UpdateStatus(ctx context.Context, xDLJob *v1alpha1.XDLJob, opts v1.UpdateOptions) (result *v1alpha1.XDLJob, err error) {
	result = &v1alpha1.XDLJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xdljobs").
...
func (c *xDLJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *xDLJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *xDLJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.XDLJob, err error) {
	result = &v1alpha1.XDLJob{}
