...
func newTFJobs(c *TrainingV1alpha1Client, namespace string) *tFJobs {
	return &tFJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tFJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TFJob, err error) {
...
func (c *tFJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TFJobList, err error) {
...
func (c *tFJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tFJobs) Create(ctx context.Context, tFJob *v1alpha1.TFJob, opts v1.CreateOptions) (result *v1alpha1.TFJob, err error) {
	result = &v1alpha1.TFJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) Update(ctx context.Context, tFJob *v1alpha1.TFJob, opts v1.UpdateOptions) (result *v1alpha1.TFJob, err error) {
	result = &v1alpha1.TFJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) UpdateStatus(ctx context.Context, tFJob *v1alpha1.TFJob, opts v1.UpdateOptions) (result *v1alpha1.TFJob, err error) {
	result = &v1alpha1.TFJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tfjobs").
...
func (c *tFJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tFJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tFJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TFJob, err error) {
	result = &v1alpha1.TFJob{}
