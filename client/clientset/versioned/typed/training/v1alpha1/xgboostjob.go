...
func newXGBoostJobs(c *TrainingV1alpha1Client, namespace string) *xGBoostJobs {
	return &xGBoostJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *xGBoostJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.XGBoostJob, err error) {
...
func (c *xGBoostJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.XGBoostJobList, err error) {
...
func (c *xGBoostJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *xGBoostJobs) Create(ctx context.Context, xGBoostJob *v1alpha1.XGBoostJob, opts v1.CreateOptions) (result *v1alpha1.XGBoostJob, err error) {
	result = &v1alpha1.XGBoostJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) Update(ctx context.Context, xGBoostJob *v1alpha1.XGBoostJob, opts v1.UpdateOptions) (result *v1alpha1.XGBoostJob, err error) {
	result = &v1alpha1.XGBoostJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) UpdateStatus(ctx context.Context, xGBoostJob *v1alpha1.XGBoostJob, opts v1.UpdateOptions) (result *v1alpha1.XGBoostJob, err error) {
	result = &v1alpha1.XGBoostJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("xgboostjobs").
...
func (c *xGBoostJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *xGBoostJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *xGBoostJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.XGBoostJob, err error) {
	result = &v1alpha1.XGBoostJob{}
