...
func newPyTorchJobs(c *TrainingV1alpha1Client, namespace string) *pyTorchJobs {
	return &pyTorchJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pyTorchJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PyTorchJob, err error) {
...
func (c *pyTorchJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PyTorchJobList, err error) {
...
func (c *pyTorchJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pyTorchJobs) Create(ctx context.Context, pyTorchJob *v1alpha1.PyTorchJob, opts v1.CreateOptions) (result *v1alpha1.PyTorchJob, err error) {
	result = &v1alpha1.PyTorchJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) Update(ctx context.Context, pyTorchJob *v1alpha1.PyTorchJob, opts v1.UpdateOptions) (result *v1alpha1.PyTorchJob, err error) {
	result = &v1alpha1.PyTorchJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) UpdateStatus(ctx context.Context, pyTorchJob *v1alpha1.PyTorchJob, opts v1.UpdateOptions) (result *v1alpha1.PyTorchJob, err error) {
	result = &v1alpha1.PyTorchJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pyTorchJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pyTorchJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PyTorchJob, err error) {
	result = &v1alpha1.PyTorchJob{}
