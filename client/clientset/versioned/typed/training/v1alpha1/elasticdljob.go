...
// ElasticDLJobsGetter has a method to return a ElasticDLJobInterface.
...
// elasticDLJobs implements ElasticDLJobInterface
type elasticDLJobs struct {
	client rest.Interface
	ns     string
}

// newElasticDLJobs returns a ElasticDLJobs
func newElasticDLJobs(c *TrainingV1alpha1Client, namespace string) *elasticDLJobs {
	return &elasticDLJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *elasticDLJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElasticDLJob, err error) {
	result = &v1alpha1.ElasticDLJob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("elasticdljobs").
		Name(name).
...
func (c *elasticDLJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElasticDLJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ElasticDLJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("elasticdljobs").
...
func (c *elasticDLJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticDLJobs) Create(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.CreateOptions) (result *v1alpha1.ElasticDLJob, err error) {
	result = &v1alpha1.ElasticDLJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticdljobs").
...
func (c *elasticDLJobs) Update(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.UpdateOptions) (result *v1alpha1.ElasticDLJob, err error) {
	result = &v1alpha1.ElasticDLJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticdljobs").
		Name(elasticDLJob.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(elasticDLJob).
		Do(ctx).
		Into(result)
...
func (c *elasticDLJobs) UpdateStatus(ctx context.Context, elasticDLJob *v1alpha1.ElasticDLJob, opts v1.UpdateOptions) (result *v1alpha1.ElasticDLJob, err error) {
	result = &v1alpha1.ElasticDLJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticdljobs").
...
func (c *elasticDLJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elasticDLJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elasticDLJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElasticDLJob, err error) {
	result = &v1alpha1.ElasticDLJob{}
